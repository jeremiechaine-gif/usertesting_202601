...
export const MissingPartsPage: React.FC<{ onNavigate?: (page: string) => void; onLogout?: () => void }> = ({ onNavigate, onLogout }) => {
    ...
    <div className="flex h-screen bg-[var(--color-bg-primary)]">
      ...
      {routineModalOpen && (
        <RoutineModal
          ...
          currentPelicoView={routineModalMode === 'create' ? 'missing-parts' : undefined}
        />
      )}
    </div>
  );
